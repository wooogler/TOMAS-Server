...
async function main() {
  ...
  // const movieSelect = await pageHandler.select("#boxo_movie", true);

  // showScreenResults(movieSelect);
  ...
  const selectDate = await pageHandler.click("#playDate_20231204 > a", true);
  showScreenResults(selectDate);
